...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        // COMPLETED (4) If your user is not on M+, then...
            ...
            int batteryExtraStatus = intent.getIntExtra(BatteryManager.EXTRA_STATUS, -1);
            boolean isCharging = batteryExtraStatus == BatteryManager.BATTERY_STATUS_CHARGING || batteryExtraStatus == BatteryManager.BATTERY_STATUS_FULL;
