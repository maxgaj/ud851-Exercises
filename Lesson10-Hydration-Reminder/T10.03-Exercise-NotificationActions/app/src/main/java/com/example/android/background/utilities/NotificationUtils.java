...
public class NotificationUtils {
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        Intent incrementCountIntent = new Intent(context, WaterReminderIntentService.class);
        incrementCountIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        PendingIntent incrementCountPendingIntent = PendingIntent.getService(
                context,
