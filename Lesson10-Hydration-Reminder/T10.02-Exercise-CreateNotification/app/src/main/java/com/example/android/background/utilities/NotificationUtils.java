...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENDING_INTENT = 3001;
    private static final int WATER_REMINDER_NOTIFICATION_ID = 1001;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL = "reminder_notification_channel";
    ...
    public static void remindUserBecauseCharging(Context context){
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_CHANNEL)
                        .setColor(ContextCompat.getColor(context, R.color.colorPrimary))
                        .setSmallIcon(R.drawable.ic_drink_notification)
                        .setLargeIcon(largeIncon(context))
    ...
    private static Bitmap largeIncon(Context context){
